...
function AccountWideSettings:LoadMainWindow()
  ...
  -- Print(tostring(strWildstarDir))
  -- Print(tostring(strSeperator))
  -- Print(tostring(strAddonsXml))
  
  if not strWildstarDir then return end
    ...
    if v.__XmlNode == "Addon" then
      ...
      if strAddonName then
        ...
        if tAddon and tAddon.OnSave then
          table.insert(tAddonList, strAddonName)
        elseif tAddon then
